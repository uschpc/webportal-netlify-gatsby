            ...
            <div className="container">
                ...
                {content.frontmatter.title !== "Frequently Asked Questions" ? (
                   ...
                   <div className="system-status">
                       ...
                       <ul>
                         <li><a href="https://carc.usc.edu/user-information/user-guides/high-performance-computing/getting-started" target="_blank">Getting Started with the Discovery Cluster</a></li>
