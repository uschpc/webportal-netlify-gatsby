            ...
            <div className="coldFront-child-container">
              ...
              <div className="page-body">
                <div className="left-column">
                  ...
                  <SideMenu {...data} parentMenuTitle="Hybrid Cloud Computing"/>
                </div>
...
export const cloudComputingQuery = graphql`
  query($slug: String!) {
    md: markdownRemark(frontmatter: {cat: {eq: "cloudComputing"}, path: {eq: $slug}}) {
      frontmatter {
        title
        path
        parentPath
    ...
    subMenu: allMarkdownRemark(sort: {fields: frontmatter___id},filter: {frontmatter: {cat: {eq: "cloudComputing"}}}) {
      edges {
        node {
          frontmatter {
            title
    ...
    subMenuLevel2: allMarkdownRemark(sort: {fields: frontmatter___id}, filter: {frontmatter: {cat: {eq: "cloudComputing"}}}) {
      edges {
        node {
          frontmatter {
            title
    ...
    content: markdownRemark(frontmatter: {cat: {eq: "cloudComputing"}, path: {eq: $slug}}) {
      frontmatter {
        title
        path
        parentPath
