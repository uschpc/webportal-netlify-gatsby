...
A multi-threaded job, as the name implies, uses more than 1 core but still only uses 1 compute node. This is a common use case on Discovery as it enables basic parallel computing.
