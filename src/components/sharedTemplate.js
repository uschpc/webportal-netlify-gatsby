                ...
                {items.cat === 'userSupport' ? (
                    <div className="right-col">
                        <div className="system-status">
                            <h3>System Status <a href="https://hpc-grafana.usc.edu/d/vsUGHjmMk/compute-node-usage?orgId=1&refresh=30s" target="_blank"><i class="fa fa-external-link" style={{fontSize:"24px"}}></i></a></h3>
