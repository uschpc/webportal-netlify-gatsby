...
const Announcement = (props) => {
    return (
        <div className="shared press-release discourse">
            ...
            <div className="links">
                <Link className="link" to="/news-and-events/news-and-announcements"><img src="/images/news-arrows.svg" alt="View news and announcements" />View news and announcements</Link>
                <Link className="link" to="/news-and-events/events"><img src="/images/news-arrows.svg" alt="View upcoming events" />View upcoming events</Link>
            </div>
